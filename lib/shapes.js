...
// specific shape classes inheriting properties of class Shape
class Circle extends Shape {
  constructor(text, textColor, shapeColor) {
    super(text, textColor, shapeColor, 'circle');
  }

  // renders the specific shape tag
  render() {
...
// function to render the svg; makes the code block into a string and creates a file containing that string.
...
// exporting the specific shape classes and the function to render the svg file
