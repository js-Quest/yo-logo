...
// testing for the specific shape and text tags rendering correctly

const text = 'YES';
const textColor = 'white'
const shapeColor = '#3395FF'

// tests will successfully pass if the result equals these constants, named with the prefix 'pass'
...
// tests for rendering of shape tags
...
// test for rendering of text tag
describe('add text', () => {
